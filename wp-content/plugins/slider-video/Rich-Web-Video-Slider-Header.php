...
<style type="text/css">
	...
	.Rich_Web_Header_Free_Version a:hover, .Rich_Web_Header_Free_Version a:focus, .Rich_Web_Header_Contacts a:hover, .Rich_Web_Header_Contacts a:focus { outline: none; }
	.Rich_Web_Header_Free_Version a:hover, .Rich_Web_Header_Free_Version a:focus, .Rich_Web_Header_Contacts a:focus { box-shadow: none; }
...
<div class='Rich_Web_Header_Main'>
	...
	<div class="Rich_Web_Header_Free_Version">
		<a href="http://rich-web.esy.es/slider-video/" target="_blank" style="text-decoration: none; color: #fff; display: block;">
	...
	<div class="Rich_Web_Header_Contacts">
		...
		<a href="http://rich-web.esy.es/slider-video-content-slider/" target="_blank">Demo</a>
		...
		<a href="http://rich-web.esy.es/contact-us/" target="_blank">Contact US</a>
	</div>	
</div>