<?php
	...
	require_once( 'Rich-Web-Video-Slider-Header.php' );
?>
<style type="text/css">
	...
	.Rich_Web_Products_Product_Div { float: left; position: relative; width: 270px; height: 530px; text-align: center; background: #fff; margin-left: 5px; margin-top: 5px; box-shadow: 0px 0px 20px #c0c0c0 inset;	}
	.Rich_Web_Products_Product_Div img { margin-top: 10px; }
	.Rich_Web_Products_Product_Div p { padding: 0px 15px 10px 15px;	text-align: justify; font-size: 14px; line-height: 1; text-shadow: 0px 0px 1px #6ecae9; }
	.Rich_Web_Products_Product_Div p span { margin-left: 5px; margin-right: 3px; padding: 0px; font-size: 24px; color: #6ecae9; font-style: bold; text-shadow: 0px 0px 1px #000; }
	.Rich_Web_Products_Product_Div h1 { display: block; width: 90%; margin: 0 auto; border-top: 1px solid #6ecae9; }
	.Rich_Web_Products_Product_Div a { padding: 8px 0px; box-shadow: 0px 0px 20px #c0c0c0 inset; width: 90%; text-decoration: none; color: #000; text-shadow: 0px 0px 1px #000; position: absolute; left: 5%; bottom: 10px; }
	.Rich_Web_Products_Product_Div a:hover { box-shadow: 0px 0px 20px #8a8a8a inset; color: #000; text-shadow: 0px 0px 1px #8a8a8a; }
</style>
<div class="Rich_Web_Products_Main_Div">
	...
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.esy.es/wordpress-share-button/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.esy.es/wordpress-timeline/" target="_blank"> View More </a>
	</div>
</div>